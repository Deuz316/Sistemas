...
#Region "Metodos & Procedimientos"
    ...
    Private Sub BarButtonItem1_ItemClick(sender As Object, e As ItemClickEventArgs) Handles BarButtonItem1.ItemClick
        cargar_formularios(Me, FrmFacturacion)
    End Sub

    Private Sub BarButtonItem7_ItemClick(sender As Object, e As ItemClickEventArgs)
    ...
    Private Sub BarButtonItem8_ItemClick(sender As Object, e As ItemClickEventArgs) Handles BarButtonItem8.ItemClick
        cargar_formulario(FrmPlantillas, 1)
    End Sub

    Private Sub FrmMenu_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        obtener_intervalos_fecha(Me.BarEditItem1, Me.BarEditItem2)
    End Sub
