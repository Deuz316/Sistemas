...
CREATE TRIGGER MIGRACION_INVENTARIO ON MIGRAR_INVENTARIO
AFTER INSERT
AS
  BEGIN
  ...
  FROM INSERTED
    ...
    INSERT PRODUCTOS (
      ...
      INSERT PEB (ID_BODEGA, CODIGO_COMPUESTO,PRECIO,EXISTENCIAS,DISPONIBILIDAD,UBICACION) VALUES(
      (SELECT ID_BODEGA FROM BODEGA WHERE DESCRIPCION = @BODEGA),
      @CODIGO,
      @PRECIO,
      @EXISTENCIAS,
      @EXISTENCIAS,
